...
public class AppStep1Ingestion {
    ...
    private static final OllamaAccess allamaAccess = new OllamaAccess();
    ...
    public static void main(String[] args) {
        ...
        // TODO 2: Check the prompt in the class OllamaKnowledgeExtractor, you can try to improve it.
...
//        LOGGER.info("Answer: {}", answer);
    ...
    private static List<Chunk> semanticSplitting(InputDocument inputDocument) {
        Splitter splitter;
        ChatService chatService = new OllamaChatService(allamaAccess, MODEL_LLAMA3);
    ...
    private static InternalContentStore initContentStore(List<Chunk> chunks) {
        Embedder embedder = new OllamaEmbedder(allamaAccess); // use default embedding model
